...
CSGO-8odec-LZ6pB-hHMJx-zFntE-dz8CH # Aqua cross
...
## Catppuccin Mocha in Zen-Browser

Roughly follow [this guide](https://youtu.be/tSfDZiK3eHk?si=bj0i5Xi2ITuYfuJK)

- Open new tab in Zen and open `about:support`
- In the first table on the page, find the **Profile Folder** row and click **Open Directory**
- Create new folder `chrome` if not already present
- Go to [github.com/catppuccin/zen-browser](https://github.com/catppuccin/zen-browser) and copy 
`userChrome.css`, `userContent.css`, and `zen-logo.csv` from your prefered flavour from the 
[themes/](https://github.com/catppuccin/zen-browser/blob/main/themes) directory to your `chrome` folder
- Enable `toolkit.legacyUserProfileCustomizations.stylesheets` in `about:config`
- Proceed with the steps from [this video](https://youtu.be/tSfDZiK3eHk?si=9AHFrsSD-9HMtUYL&t=98) or 
follow the steps listed [here](https://github.com/catppuccin/dark-reader?tab=readme-ov-file#usage) and 
[here](https://userstyles.catppuccin.com/getting-started/usage/)
